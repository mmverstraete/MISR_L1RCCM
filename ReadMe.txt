...
IDL routines with a version number 2.2.0 correspond to the state of the software described in the peer-reviewed paper referenced in the documentation.
